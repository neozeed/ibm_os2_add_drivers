/*static char *SCCSID = "@(#)bseerr.h	6.18 92/02/08";*/
/****************************** Module Header ******************************\
*
...
#define ERROR_BIDI_INVALID_LENGTH       671    /* MSG%none */
#define ERROR_BIDI_INVALID_INCREMENT    672    /* MSG%none */
#define ERROR_BIDI_INVALID_COMBINATION  673    /* MSG%none */
#define ERROR_BIDI_INVALID_RESERVED     674    /* MSG%none */
#define ERROR_BIDI_INVALID_EFFECT       675    /* MSG%none */
#define ERROR_BIDI_INVALID_CSDREC       676    /* MSG%none */
#define ERROR_BIDI_INVALID_CSDSTATE     677    /* MSG%none */
#define ERROR_BIDI_INVALID_LEVEL        678    /* MSG%none */
#define ERROR_BIDI_INVALID_TYPE_SUPPORT 679    /* MSG%none */
#define ERROR_BIDI_INVALID_ORIENTATION  680    /* MSG%none */
#define ERROR_BIDI_INVALID_NUM_SHAPE    681    /* MSG%none */
#define ERROR_BIDI_INVALID_CSD          682    /* MSG%none */
#define ERROR_BIDI_NO_SUPPORT           683    /* MSG%none */
...
#define MSG_HPFS_DISK_ERROR_WARN  693     /* MSG%HPFS_DISK_ERROR_WARN */
